...
public class runeSmithingCalculator {
    ...
    TableRow barrow, daggerrow, axerow, macerow, medhelmrow, boltsrow,
            ...
            sword2hrow, skirtrow, legsrow, bodyrow;
    ...
    TextView na, bartxt, daggertxt, axetxt, macetxt, medhelmtxt, boltstxt,
            ...
            sword2htxt, skirttxt, legstxt, bodytxt;

    String b, sB, s2B, s3B, s5B;

    int bar, barToGo, smithBar, smithBarToGo, smith2BarToGo, smith3BarToGo, smith5BarToGo,
            bonus = 1;
