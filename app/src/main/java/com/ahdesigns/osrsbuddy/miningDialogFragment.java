...
public class miningDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstance) {
        ...
        View options = View.inflate(getContext(), R.layout.miningoptions, null);
        final CheckBox prospect = options.findViewById(R.id.prospect);
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        if (prospect.isChecked()) {
                            intent.putExtra("prospect", "true");
                        } else {
                            intent.putExtra("prospect", "false");
                        }
